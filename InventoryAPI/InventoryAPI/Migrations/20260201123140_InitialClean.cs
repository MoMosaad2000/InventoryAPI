...
namespace InventoryAPI.Migrations
{
    ...
    public partial class InitialClean : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AllocationBasis = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MainClassification = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "OperationCostItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    OperationCostId = table.Column<int>(type: "int", nullable: false),
                    ProductCode = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProductName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Quantity = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    MaterialsCost = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    WagesCost = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    AdditionalOperatingCost = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    TotalOperatingCost = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    SalesMarketingCost = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    AdminCost = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    TotalProductCost = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    Status = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperationCostItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OperationCostItems_OperationCosts_OperationCostId",
                        column: x => x.OperationCostId,
                        principalTable: "OperationCosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperatingOrderNumber = table.Column<int>(type: "int", nullable: true),
                    FromWarehouseId = table.Column<int>(type: "int", nullable: false),
                    ToWarehouseId = table.Column<int>(type: "int", nullable: false),
                    DepartmentCategoryId = table.Column<int>(type: "int", nullable: true),
                    RequesterName = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Notes = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Status = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RequesterSignature = table.Column<byte[]>(type: "longblob", nullable: true),
                    RequesterSignatureMimeType = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StoreKeeperSignature = table.Column<byte[]>(type: "longblob", nullable: true),
                    StoreKeeperSignatureMimeType = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaterialIssues_Warehouses_FromWarehouseId",
                        column: x => x.FromWarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaterialIssues_Warehouses_ToWarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableQtyAtTime = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialIssueLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MaterialIssueLines_MaterialIssues_MaterialIssueId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockInVoucherId = table.Column<int>(type: "int", nullable: true),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    WarehouseId = table.Column<int>(type: "int", nullable: false),
                    Unit = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialIssueLines_MaterialIssueId",
                table: "MaterialIssueLines",
                column: "MaterialIssueId");

            migrationBuilder.CreateIndex(
                name: "IX_MaterialIssues_FromWarehouseId",
                table: "MaterialIssues",
                column: "FromWarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_MaterialIssues_ToWarehouseId",
                table: "MaterialIssues",
                column: "ToWarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_OperationCostItems_OperationCostId",
                table: "OperationCostItems",
                column: "OperationCostId");
